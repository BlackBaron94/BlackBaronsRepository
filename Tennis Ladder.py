...
def test():
    '''Εκχωρεί τυχαία λίστα με τιμές για δοκιμές στον πίνακα της Βάσης Δεδομένων'''
    if not empty_check(1):
        return print("Διαγράψτε την κατάταξη πρωτού χρησιμοποιήσετε αυτή τη λειτουργία.")
    my_conn = dbconnect('tennis_club.db')
    c = my_conn.cursor()
    ...
    c.execute("INSERT INTO ranking VALUES ('4', 'Νίκος', 'Παπαδημητρίου', '3', '2', '24/5/2023');")
    c.execute("INSERT INTO ranking VALUES ('5', 'Αντώνης', 'Διαμαντής', '3', '2', '29/4/2023');")
    c.execute("INSERT INTO ranking VALUES ('6', 'Χρήστος', 'Χατζής', '3', '3', '21/4/2023');")
    c.execute("INSERT INTO ranking VALUES ('7', 'Βλαδίμιρος', 'Δεβεροβοριάς', '2', '3', '30/5/2023');")
    ...
    c.execute("INSERT INTO ranking VALUES ('13', 'Περικλής', 'Αυλωνίτης', '1', '3', '2/6/2023');")
    c.execute("INSERT INTO ranking VALUES ('14', 'Χαράλαμπος', 'Φωτιάδης', '1', '2', '7/6/2023');")
    c.execute("INSERT INTO ranking VALUES ('15', 'Φώτης', 'Χαραλαμπίδης', '0', '3', '3/5/2023');")
    my_conn.commit()
    my_conn.close()
...
def print_ranking():
    '''Τύπωση πίνακα σε μορφή πλειάδων για ελέγχους κατά τις δοκιμές'''
    my_conn = dbconnect('tennis_club.db')
    c = my_conn.cursor()
...
def check_ranking_for_decay(today=today):
    ...
    if decaylist: #Αν η λίστα δεν είναι κενή
        print('Οι παίκτες στις θέσεις')
        print(*decaylist, sep=',')
        print('έπεσαν μία θέση λόγω αδράνειας και η κατάταξη ανανεώθηκε.')
...
while True:
    ...
    try:
        ...
        elif choice == 0: #Δημιουργία τυχαιοποιημένης κατάταξης για δοκιμές
            go()
